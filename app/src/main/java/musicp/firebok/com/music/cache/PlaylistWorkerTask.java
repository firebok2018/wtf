...
import musicp.firebok.com.music.loaders.PlaylistSongLoader;
import musicp.firebok.com.music.loaders.SortedCursor;
import musicp.firebok.com.music.provider.PlaylistArtworkStore;
...
public class PlaylistWorkerTask extends BitmapWorkerTask<Void, Void, TransitionDrawable> {
    ...
    public PlaylistWorkerTask(final String key, final long playlistId, final PlaylistWorkerType type,
        ...
        super(key, imageView, ImageWorker.ImageType.PLAYLIST, fromDrawable, context);
    ...
    protected Bitmap loadTopArtist(Cursor sortedCursor) {
        ...
        do {
            ...
            bitmap = ImageWorker.getBitmapInBackground(mContext, mImageCache, artistName,
                    null, artistName, -1, ImageWorker.ImageType.ARTIST);
        ...
        do {
            ...
            if (keys.add(key)) {
                ...
                bitmap = ImageWorker.getBitmapInBackground(mContext, mImageCache,
                        key, albumName, artistName, albumId, ImageWorker.ImageType.ALBUM);
        ...
        if (imageView != null) {
            if (transitionDrawable != null) {
                ...
                ImageFetcher.getInstance(mContext).loadDefaultImage(imageView,
                        ImageWorker.ImageType.PLAYLIST, null, String.valueOf(mPlaylistId));
            }
        }
    }
}
