...
import musicp.firebok.com.music.adapters.ProfileSongAdapter;
import musicp.firebok.com.music.dragdrop.DragSortListView;
...
import musicp.firebok.com.music.utils.PlaylistPopupMenuHelper;
import musicp.firebok.com.music.utils.PopupMenuHelper;
import musicp.firebok.com.music.utils.SongPopupMenuHelper;
import musicp.firebok.com.music.widgets.LoadingEmptyContainer;

public class PlaylistDetailFragment extends FadingBarFragment implements
        LoaderCallbacks<List<Song>>, OnItemClickListener, DragSortListView.DropListener,
        DragSortListView.RemoveListener, DragSortListView.DragScrollProfile, IChildFragment {
    ...
    protected PopupMenuHelper createActionMenuHelper() {
        return new PlaylistPopupMenuHelper(
                getActivity(), getChildFragmentManager(), PopupMenuHelper.PopupMenuType.Playlist) {
